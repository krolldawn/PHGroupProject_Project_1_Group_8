...
##WeeklyMinutesModerateExercise Summary
#Converts data to numeric format.
rel.data$V16 <- as.numeric(rel.data$V16)
...
#calculates mean on V16
mean(rel.data$V16, na.rm = TRUE) 

#calculates sd of V16
sd(rel.data$V16, na.rm = TRUE) 

#calculates variance of V16
var(rel.data$V16, na.rm = TRUE) 
...
##AvgDrinksPerWeek Summary
#Converts data to numeric format.
rel.data$V17 <- as.numeric(rel.data$V14)
